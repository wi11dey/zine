...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_set_builder] = sym_set_builder,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [157] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_set_builder, 5, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_set_builder, 5, 0, 0),
